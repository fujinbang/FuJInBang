...
import com.fujinbang.internet.MallRequest;
...
//            }
    ...
    protected void initNavigationBar() {
        ...
        mNavigationBar.setLayoutParams(new LayoutParams(LayoutParams.MATCH_PARENT, dp20));
        ...
        RelativeLayout.LayoutParams mBackLayout = new RelativeLayout.LayoutParams(LayoutParams.WRAP_CONTENT, LayoutParams.WRAP_CONTENT);
    ...
    public static void startActivity(final Activity context) {
        new MallRequest(context).getMallURL(new SimpleDataBase(context).getToken(), new MallRequest.OnMallRequestListener() {
            @Override
            public void onSucess(final String url) {
                Intent intent = new Intent(context, CreditActivity.class);
                intent.putExtra("navColor", "#FFAF00");    //配置导航条的背景颜色，请用#ffffff长格式。
            ...
            public void onError(String desc) {
                Log.e("zy", "start creditActivity error:" + desc);
                Toast.makeText(context.getApplicationContext(), "连接积分商城失败！", Toast.LENGTH_SHORT);
            }
        });
    }
}