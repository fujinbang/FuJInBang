...
public class SetActivity extends BaseActivity implements View.OnTouchListener, CompoundButton.OnCheckedChangeListener, ISetActivity {
    ...
    protected void onResume() {
        super.onResume();
        tv_set_range.setText(presenter.getRange() + "米");
    }
        ...
        btn_ok.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (dialog != null) {
                    ...
                    dialog.dismiss();
                    final Dialog progressDlg = ProgressDialog.show(SetActivity.this, "请稍候", "正在验证", true);
        ...
        AlertDialog alertDialog = new AlertDialog.Builder(this).setTitle("提醒")
                ...
                .setPositiveButton("确定", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ((NeibourApplication) getApplication()).exit();
                    }
