...
import com.fujinbang.ui.fragment.ConversationFragment;
import com.fujinbang.ui.fragment.NeibourFragment;
import com.fujinbang.ui.fragment.SeekHelpFragment;
import com.fujinbang.ui.fragment.SettingFragment;
import com.fujinbang.ui.view.NeibourTabView;
            ...
            public void onInvitedSucceed(List<HashMap<String, Object>> invitedMission) {
                ...
                for (int i = 0;i<invitedMission.size();i++){
                    if (invitedMission.get(i).containsKey("voicelength") &&
                        ...
                        missionDetail.initAudio(invitedMission.get(i).get("helpid").toString(), invitedMission.get(i).get("voicelength").toString());
                    }
                }
                missionDetail.getInvitedNeederNickName(new MissionDetail.OnLoadNeederNickName() {
                    @Override
