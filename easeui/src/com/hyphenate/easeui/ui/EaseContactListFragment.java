...
public class EaseContactListFragment extends EaseBaseFragment {
    ...
    private int img;
    private OnClickListener titleRightListener;
...
//                    itemClickLaunchIntent.putExtra(EaseConstant.USER_ID, username);
        ...
        titleBar.setTitle("帮友录");
        titleBar.setRightImageResource(img);
        titleBar.setRightLayoutClickListener(titleRightListener);
    ...
    public void initRightTxt(int img,OnClickListener mListener){
        this.img = img;
        this.titleRightListener = mListener;
    }
