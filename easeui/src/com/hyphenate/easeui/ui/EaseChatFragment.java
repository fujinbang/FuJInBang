...
public class EaseChatFragment extends EaseBaseFragment {
    ...
    protected static final int REQUEST_CODE_FILE = 2;
    ...
    static final int ITEM_FILE = 1;
    static final int ITEM_PICTURE = 2;
    static final int ITEM_LOCATION = 3;
    
    protected int[] itemStrings = { R.string.attach_file, R.string.attach_picture, R.string.attach_location };
    protected int[] itemdrawables = { R.drawable.em_chat_file_normal, R.drawable.ease_chat_image_selector,
            R.drawable.ease_chat_location_selector };
    protected int[] itemIds = { ITEM_FILE, ITEM_PICTURE, ITEM_LOCATION };
    private EMChatRoomChangeListener chatRoomChangeListener;
    private boolean isMessageListInited;
    protected MyItemClickListener extendMenuItemClickListener;

    private OnClickListener myMissionClickListener;
    public void setMyMissionClickListener(OnClickListener mListener){
    ...
    protected void setUpView() {
        ...
        titleBar.setRightTxtClickListener(myMissionClickListener);
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == Activity.RESULT_OK) { 
            if (requestCode == REQUEST_CODE_FILE) { // 发送文件
                if (data != null) {
                ...
                if (locationAddress != null && !locationAddress.equals("")) {
                    ...
                    Toast.makeText(getActivity(), R.string.unable_to_get_loaction, Toast.LENGTH_LONG).show();
                }
