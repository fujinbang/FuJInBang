...
public class PersonalHelpActivity extends BaseActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        simpleDataBase = new SimpleDataBase(PersonalHelpActivity.this);
    ...
    private void initView() {
        ...
        getPoi((double)data.get("x"), (double)data.get("y"));
    ...
    public void onClick(View v) {
        switch (v.getId()){
            ...
            case R.id.personal_help_refuse_btn:
                //拒绝
                dropMission(simpleDataBase.getToken(), data.get("helpid").toString());
                break;
            ...
            case R.id.personal_help_recoder_lenght:
                ...
                animation.start();
                //播放录音
                MediaManager.playSound(PersonalHelpActivity.this, new File(dir, data.get("helpid").toString() + ".aac").getAbsolutePath(), new MediaPlayer.OnCompletionListener() {
     ...
     * 获得定位的标志性地名
     */
    private void getPoi(double x, double y) {
        ...
        new AsyncTask<String, Integer, String>() {
            ...
            protected String doInBackground(String... params) {
                ...
                try {
                    ...
                    result = HttpConnRequest.request(UrlConstant.joinMission,"POST",object);
    ...
    protected boolean canDropMission = true;
    protected void dropMission(String token, String helpid){
        if (!canDropMission){
            return;
        }
        canDropMission = false;
        new AsyncTask<String, Integer, String>() {
            @Override
            protected String doInBackground(String... params) {
                String result = null;
                ...
                if (result!=null){
                    try{
                        ...
                        if (obj.getInt("code") == 1){
                            Toast.makeText(PersonalHelpActivity.this, "您已拒绝该任务", Toast.LENGTH_SHORT).show();
                            PersonalHelpActivity.this.finish();
                        }
                    }catch (Exception e){
                        e.printStackTrace();
